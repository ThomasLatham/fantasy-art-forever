/*
  ...
  - You are about to drop the column `redditPostId` on the `QueuedInstagramPost` table. All the data in the column will be lost.
  - Added the required column `redditPostUrl` to the `QueuedInstagramPost` table without a default value. This is not possible if the table is not empty.
